...
from mininetfed.sim.util.docker_utils import docker_image_exists, build_fed_broker_docker_image, build_fed_node_docker_image
...
class FedServerNode(DockerFedNode):
    ...
    def __init__(self, server_id : str, script: str | None = None, server_folder : str | None = None , dimage : str | None = None, server_args : dict | None = None):
        ...
        self.script = script or "default_fed_server.py"
        ...
        super().__init__( node_id = server_id, node_folder = server_folder, dimage = server_docker_image, node_args = server_args)
        self.cmd("ifconfig eth0 down")
...
class FedBrokerNode(DockerFedNode):
    ...
    def __init__(self, broker_id : str, broker_folder : str | None = None , dimage : str | None = None, broker_args : dict | None = None):
        ...
        self.script = "default_fed_broker.py"
        ...
        super().__init__( node_id = broker_id, node_folder = broker_folder, dimage = broker_docker_image, node_args = broker_args)
